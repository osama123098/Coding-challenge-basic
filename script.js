...
// 2
const [gk,...field_player]=players1
console.log(gk,field_player)
...
// 4
const players_final = ['Thiago', 'Coutinho', 'Perisic', ...players1]
console.log(players_final)
...
function printGoals(...players){
    console.log(`The ${players.length} goal made by  `)
...
console.log(`average ${avg/odd.length}`)
...
// 4
const test = game.scored
let scores = {}
for (const name of test) {
    scores[name] ? scores[name] += 1 : scores[name] = 1 
